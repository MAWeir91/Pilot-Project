...
async function serviceWithTask(
  task: TaskRecord,
  options: Record<string, unknown> & { buildReport?: string; reviewReport?: string; withRun?: boolean } = {}
) {
...
function omitBuildReportOption(options: Record<string, unknown> & { buildReport?: string; reviewReport?: string; withRun?: boolean }): Record<string, unknown> {
