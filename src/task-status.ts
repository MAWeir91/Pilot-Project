...
export const NOTIFIABLE_TASK_STATUSES = new Set<TaskStatus>([
  "failed",
  "blocked",
  "needs-fixes",
  "ready-for-approval"
...
export function deriveTaskStatus(task: TaskRecord): TaskStatus {
...
export function completeReadyTask(task: TaskRecord, completedAt: string): TaskRecord {
