import type { PlanInput, TaskInput } from "./types.js";

export function renderTaskMarkdown(taskId: string, input: TaskInput): string {
...
export function planPrompt(planId: string, input: PlanInput): string {
